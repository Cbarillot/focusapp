  ...
  <div class="app">
    ...
    <div class="main-layout">
      ...
      <main class="timer-area" :class="`mode-${store.timerDisplayMode}`">
        ...
        <!-- Timer is handled by the unified left sidebar pomodoro module above -->
        <div v-else-if="store.timerDisplayMode === 'ambiance'" class="ambiance-mode-content">
          <!-- Empty - content handled by unified sidebar system -->
        </div>
      </main>

      <!-- Unified Left Sidebar (All Modes) -->
      <div class="unified-left-sidebar" :class="{ expanded: unifiedLeftExpanded }">
        <!-- Pomodoro Module (Only for Ambiance Mode) -->
        <div v-if="store.timerDisplayMode === 'ambiance'" class="ambiance-pomodoro-module">
          <!-- Mode Tabs -->
