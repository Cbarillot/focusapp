<template>
  <div class="app">
    ...
    <div class="main-layout">
      ...
      <!-- Todo Sidebar - Available in focus and home modes only -->
      <TodoSidebar v-if="store.timerDisplayMode !== 'ambiance'" />
      
      <!-- Theme Selector - Available in focus and home modes only -->
      <ThemeSelector v-if="store.timerDisplayMode !== 'ambiance'" />
      
      <!-- Corner Navigation - Adjusted for ambiance mode -->
      <CornerNavigation v-if="store.timerDisplayMode !== 'ambiance'" />
      ...
      <!-- Unified Theme Mode Switcher (Bottom Center) -->
      <div class="unified-theme-switcher">
        <div class="theme-mode-icons">
          <button 
            class="theme-mode-btn"
            :class="{ active: store.timerDisplayMode === 'home' }"
...
/* Ambiance timer module positioning */
