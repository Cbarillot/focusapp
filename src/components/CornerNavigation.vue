<template>
  ...
  <div class="corner-navigation">
    ...
    <div class="corner-container corner-bottom-right">
      ...
      >
        <!-- Home Theme Icon -->
        <svg v-if="store.currentTheme === 'home'" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path d="M3 9L12 2L21 9V20C21 20.5304 20.7893 21.0391 20.4142 21.4142C20.0391 21.7893 19.5304 22 19 22H5C4.46957 22 3.96086 21.7893 3.58579 21.4142C3.21071 21.0391 3 20.5304 3 20V9Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
          <path d="M9 22V12H15V22" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        <!-- Ambiance Theme Icon -->
        <svg v-else-if="store.currentTheme === 'ambiance'" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
        <!-- Focus Theme Icon -->
        <svg v-else-if="store.currentTheme === 'focus'" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          <circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="2"/>
        ...
        <!-- Default Palette Icon for other themes -->
        <svg v-else width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
          ...
          <path d="M12 2C6.5 2 2 6.5 2 12S6.5 22 12 22C13.6 22 15.1 21.5 16.4 20.8L14 18.4C13.4 18.8 12.7 19 12 19C8.1 19 5 15.9 5 12S8.1 5 12 5 19 8.1 19 12C19 12.3 19 12.6 18.9 12.9L21.5 15.5C21.8 14.4 22 13.2 22 12C22 6.5 17.5 2 12 2Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
        </svg>
      </button>
    </div>
  </div>
...
function getCurrentThemeIcon() {
  // This function is no longer needed since we use inline SVGs
  // Kept for compatibility but could be removed in future cleanup
